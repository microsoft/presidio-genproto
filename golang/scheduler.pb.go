...
type ScannerCronJobApiRequest struct {
	...
	ScannerCronJobRequest *ScannerCronJobRequest `protobuf:"bytes,2,opt,name=scannerCronJobRequest" json:"scannerCronJobRequest,omitempty"`
...
type StreamsJobApiRequest struct {
	...
	StreamsJobRequest    *StreamsJobRequest `protobuf:"bytes,2,opt,name=streamsJobRequest" json:"streamsJobRequest,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
