...
func (*PatternRecognizer) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{0}
}
...
func (*RecognizerInsertOrUpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{1}
}
...
func (*RecognizerDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{2}
}
...
func (*RecognizerGetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{3}
}
...
func (*RecognizersGetAllRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{4}
}
...
func (*RecognizerGetTimestampRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{5}
}
...
func (*RecognizersStoreResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{6}
}
...
func (*RecognizersGetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{7}
}
...
func (*RecognizerTimestampResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_recognizers_store_1a25376fa67c804b, []int{8}
}
...
func init() {
	proto.RegisterFile("recognizers_store.proto", fileDescriptor_recognizers_store_1a25376fa67c804b)
}

var fileDescriptor_recognizers_store_1a25376fa67c804b = []byte{
