...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='types',
  syntax='proto3',
  serialized_pb=_b('\n\x13\x61nonymizeJson.proto\x12\x05types\x1a\x0etemplate.proto\"\xd9\x01\n\x17\x41nonymizeJsonApiRequest\x12\x12\n\njsonSchema\x18\x01 \x01(\t\x12\x0c\n\x04json\x18\x02 \x01(\t\x12\x19\n\x11\x61nalyzeTemplateId\x18\x03 \x01(\t\x12\x1b\n\x13\x61nonymizeTemplateId\x18\x04 \x01(\t\x12/\n\x0f\x61nalyzeTemplate\x18\x06 \x01(\x0b\x32\x16.types.AnalyzeTemplate\x12\x33\n\x11\x61nonymizeTemplate\x18\x07 \x01(\x0b\x32\x18.types.AnonymizeTemplateb\x06proto3')
  ,
...
_ANONYMIZEJSONAPIREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='jsonSchema', full_name='types.AnonymizeJsonApiRequest.jsonSchema', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='json', full_name='types.AnonymizeJsonApiRequest.json', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='analyzeTemplate', full_name='types.AnonymizeJsonApiRequest.analyzeTemplate', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anonymizeTemplate', full_name='types.AnonymizeJsonApiRequest.anonymizeTemplate', index=5,
