...
_STREAMREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dataSyncTemplate', full_name='types.StreamRequest.dataSyncTemplate', index=5,
...
_STREAMREQUEST.fields_by_name['dataSyncTemplate'].message_type = template__pb2._DATASYNCTEMPLATE
